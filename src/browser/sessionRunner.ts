...
export async function runBrowserSessionExecution(
  ...
  return {
    ...
    runtime: {
      ...
      submittedPromptText: browserResult.submittedPromptText,
      submittedPromptIndex: browserResult.submittedPromptIndex,
      submittedAttachmentNames: browserResult.submittedAttachmentNames,
