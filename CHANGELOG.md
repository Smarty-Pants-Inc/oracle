...
- Remote/Bridge: make native Windows PowerShell/OpenSSH reverse tunnels avoid unsupported control-socket multiplexing, and publish foreground/background bridge state only after an authenticated health proof succeeds through the remote forward.
